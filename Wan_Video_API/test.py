...
print("📋 请输入参考素材")
print("=" * 60)
prompt_text = input("请输入文本提示 (Prompt): ").strip()
...
data = {
    # "model": "wan2.6-i2v-flash",  # Image-to-Video model requires image input
    "model": "wanx2.1-t2v-plus",  # Use Text-to-Video model for text-only input
    "input": {
        "prompt": prompt_text
    },
    "parameters": {
